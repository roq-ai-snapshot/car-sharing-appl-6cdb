  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Car Sharing Application - Revolutionizing the way you commute, one shared ride at a time. Discover convenience, savings, and sustainability."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Car Sharing Application - Revolutionizing the way you commute, one shared ride at a time. Discover convenience, savings, and sustainability.`}
            </Text>
            <Box
